...
public class MenuFragment extends Fragment {
    ...
    List<Menu> menuMaandag;
    List<Menu> menuDinsdag;
    List<Menu> menuWoensdag;
    List<Menu> menuDonderdag;
    List<Menu> menuVrijdag;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(!menus.isEmpty()) {
            menuMaandag = new ArrayList<>();
            menuDinsdag = new ArrayList<>();
            menuWoensdag = new ArrayList<>();
            menuDonderdag = new ArrayList<>();
            menuVrijdag = new ArrayList<>();
