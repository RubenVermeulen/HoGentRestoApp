...
public class RestaurantsTask extends AsyncTask<String, Void, JSONArray> {

    private MainActivity context;
    private Map<String, Restaurant> restaurants;

    public RestaurantsTask(MainActivity context) {
    ...
    protected void onPostExecute(JSONArray s) {
        ...
        RestaurantsAdapter adapter = new RestaurantsAdapter(context, values);
